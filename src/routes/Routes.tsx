	...
	return (
		<BrowserRouter basename="thewebshopapp">
			...
			<Switch>
				...
				<Route
					exact
					path={RoutingPath.adminUsersView}
				...
				<Route
					exact
					path={RoutingPath.testApi1View}
					component={TestApi1View}
				/>
				<Route
					exact
					path={RoutingPath.testApi2View}
					component={TestApi2View}
				/>
				<Route
					exact
					path={RoutingPath.testApi3View}
					component={TestApi3View}
				/>
				<Route
					exact
					path={RoutingPath.testApi4View}
					component={TestApi4View}
				/>
				<Route
					exact
					path={RoutingPath.testApi4DetailsView()}
					component={TestApi4DetailsView}
				/>
				<Route
					exact
					path={RoutingPath.testApi5View}
					component={TestApi5View}
				/>
				<Route
					exact
					path={RoutingPath.testApi6View}
					component={TestApi6View}
				/>
				<Route
					exact
					path={RoutingPath.testApi7View}
					component={TestApi7View}
				/>
