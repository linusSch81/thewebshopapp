...
export const UserProfileView = () => {
  return localStorage.user ? (
    <div className="view">
      ...
      <p>
        * component change the user profile details, e.g shipping address,
        payment details (credit card) etc*/
      </p>

      <p>
        * Link to UserShopHistoryView or add same component that is used there
        here to see the previously purchased user history *
      </p>
